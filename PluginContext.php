...
class bg_show_hide_PluginContext {
	...
	public function getEffectsEnabledOption() {
		return  esc_html($this->_effectsEnabled);
	}
	...
	public function getAnimationEffect() {
		return  esc_html($this->_animationEffect);
	}
	...
	public function getAnimationSpeed() {
		return  esc_html($this->_animationSpeed);
	}
	...
	public function getStickToBottom() {
		return  esc_html($this->_stickToBottom);
	}
